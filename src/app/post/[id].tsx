    ...
    useCallback(
      async () => {
        ...
        try {
          ...
          console.warn(
            '[post-detail] Could not load post.',
            error
          );

          setErrorMessage(
            'We could not load this post. Check your connection and try again.'
          );
    ...
    useCallback(
      async () => {
        ...
        try {
          ...
          console.warn(
            '[post-detail] Could not load more comments.',
            error
          );

          setErrorMessage(
            'More comments could not be loaded. Try again.'
          );
        } finally {
          isLoadingMoreCommentsRef.current =
            false;
    ...
    useCallback(
      async (
        ...
        try {
          ...
          console.warn(
            '[post-detail] Could not update like.',
            error
          );
    ...
    useCallback(
      async (
        ...
        if (
          ...
          comment.authorId !==
            userId ||
          commentDeleteRequests.current.has(
            comment.id
          )
        ) {
          return;
        ...
        commentDeleteRequests.current.add(
          comment.id
        );
        ...
        try {
          ...
          console.warn(
            '[post-detail] Could not delete comment.',
            error
          );
          ...
          commentDeleteRequests.current.delete(
            comment.id
          );
          ...
          <FlatList
            ...
            renderItem={({
              ...
              <CommentRow
                ...
                isDeleting={deletingCommentIds.has(
                  item.id
                )}
                onAuthorPress={
                  openAuthor
...
function DetailSkeleton() {
  ...
  return (
    <View
      accessibilityLabel="Loading post and comments"
      style={
        styles.skeleton
      }
    >
        ...
        (item) => (
          ...
          >
            <View
              style={[
                styles.skeletonBlock,
                styles.skeletonCommentAvatar,
              ]}
            />

            <View
              style={
                styles.skeletonCommentCopy
              }
            >
              <View
                style={[
                  styles.skeletonBlock,
                  styles.skeletonCommentName,
                ]}
              />
