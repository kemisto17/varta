...
-- Blocked users settings screen without reopening profile visibility.
--
-- Direct profile SELECT is intentionally blocked whenever either student has
-- blocked the other. This RPC bypasses that table policy only for rows where
-- the authenticated user is the blocker and returns a minimal directory view.
